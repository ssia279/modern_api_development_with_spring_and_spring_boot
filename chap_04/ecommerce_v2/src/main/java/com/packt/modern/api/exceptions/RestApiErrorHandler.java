...
import static com.packt.modern.api.exceptions.ErrorUtils.createError;
...
public class RestApiErrorHandler {
  ...
  public ResponseEntity<Error> handleException(HttpServletRequest request, Exception ex,
    ...
    Error error = createError(ErrorCode.GENERIC_ERROR.getErrMsgKey(), ErrorCode.GENERIC_ERROR.getErrCode(),
